...
const OPTIONAL_FIELDS = [
    ...
    'Lead.Scenario_Manager__r.Name',
    'Lead.Other_Lead_Team_Member__r.Name'
];
...
export default class LeadRecordHero extends LightningElement {
    ...
    get scenarioManagerName() {
        return this.fieldValue('Lead.Scenario_Manager__r.Name') || 'Not assigned';
    }

    get otherTeamMemberName() {
        return this.fieldValue('Lead.Other_Lead_Team_Member__r.Name') || 'Open';
    }
