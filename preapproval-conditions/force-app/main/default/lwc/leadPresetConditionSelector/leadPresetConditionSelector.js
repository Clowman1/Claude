...
export default class LeadPresetConditionSelector extends LightningElement {
    ...
    // ALL (or blank) for the whole file, PRIMARY for the primary borrower alone, otherwise a
    // Borrower record Id. Set by the borrower picker screen earlier in the flow.
    @api assignment;
